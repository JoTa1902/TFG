...
class fragment_catalog_ds : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_catalog_ds, container, false)
        ...
        // Escuchar los cambios en la base de datos para juegos de plataforma "NDS"
        val juegosRef = database.child("games")
        juegosRef.orderByChild("platform").equalTo("NDS").addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(databaseError: DatabaseError) {
                Toast.makeText(requireContext(), "Error al cargar los juegos", Toast.LENGTH_SHORT).show()
            }
        })
