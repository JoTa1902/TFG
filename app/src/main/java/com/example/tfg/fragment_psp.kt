...
class fragment_psp : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_gb, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val gameFileList = downloadsDirectory.listFiles { _, name -> name.endsWith(".iso") }
